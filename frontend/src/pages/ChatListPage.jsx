...
const NewUserResultItem = ({ user, onClick }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className={`p-4 flex items-center gap-3 border-b border-gray-50 transition-colors ${
        isAvailable ? 'hover:bg-gray-50 cursor-pointer' : 'opacity-60 cursor-not-allowed bg-gray-50/50'
      }`}
    >
      <div className="relative">
      ...
      <div className="divide-y divide-gray-100">
        ...
        {newConnections.length > 0 && (
            <div className="bg-gray-50/50">
                <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider bg-gray-100/50">
                    Start a new chat
                </div>
        ...
        {filteredConversations.length === 0 && newConnections.length === 0 && (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                ...
                <p className="text-gray-500">No chats or people found matching "{chatSearchQuery}"</p>
            </div>
            ) : conversations.length === 0 && !chatSearchQuery && (
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                <div className="bg-gray-100 p-4 rounded-full mb-4">
